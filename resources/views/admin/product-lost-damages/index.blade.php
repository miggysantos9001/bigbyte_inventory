...
<section role="main" class="content-body">
    ...
    <div class="row">
        <div class="col-12 mb-2">
            @include('alert')
            <a href="{{ route('product-missing-damages.create') }}" class="btn btn-primary btn-sm"><i class="fa fa-plus-circle"></i> Create Entry</a>
        </div>
        <div class="col-12">
            <section class="card">
                <header class="card-header">
                    ...
                    <h4 class="card-title">Product Lost & Damage List</h4>
                </header>
                <div class="card-body">
                    <section class="card">
                        <div class="card-body">
                                ...
                                <td data-title="Action" class="text-center">
                                    <div class="btn-group flex-wrap">
                                        ...
                                        <div class="dropdown-menu" role="menu" style="">
                                            <a class="dropdown-item text-1" href="{{ route('product-missing-damages.edit',$d->id) }}">Edit Entry</a>
                                        </div>
                                    </div>
                                </td>
                            </tr>
