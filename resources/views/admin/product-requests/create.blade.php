    ...
    <div class="row">
        ...
        <div class="col-4">
            <section class="card">
                <header class="card-header">
                    ...
                    <h4 class="card-title">Create Requistion</h4>
                </header>
            </section>
            <div class="card-body">
                <div class="row">
                    <div class="col-12">
                        ...
                        <div class="form-group">
                            ...
                            {!! Form::select('supplier_id',$suppliers,null,['class'=>'select2 form-control form-control-sm','placeholder'=>'-- Select One --','style'=>'width:100%;']) !!}
                        </div>
                        <div class="form-group">
        ...
        <div class="col-8">
            ...
            <div class="card-body">
                ...
                <button type="submit" class="btn btn-sm btn-success"><i class="fa fa-cart-plus"></i> Add to Cart</a></button>
            </div>
        </div>
    </div>
    {!! Form::close() !!}
        ...
        $.ajax({    //create an ajax request to load_page.php
            ...
            success: function(response){
                ...
                $.each(response,function(index,value){
                    ...
                    data += '<td><input type="text" name="products['+index+'][qty]" "class"="form-control form-control-sm" "style"="width:50px;text-align:center;" /></td>';
                    data += '</tr>';
